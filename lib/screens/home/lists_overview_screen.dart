...
import 'package:inventorymanagement/screens/bottom_sheets/add_list.dart';
import 'package:inventorymanagement/screens/bottom_sheets/settings.dart';
import 'package:inventorymanagement/screens/home/list_screen.dart';
...
class _ListsOverviewScreenState extends State<ListsOverviewScreen> {
  ...
  void initState() {
    super.initState();
    // reload lists if user signs in or out
    _authService.authStateChanges().listen((_) => _loadLists());
    _loadLists();
  }

  // save lists to cloud or local depending on sign in state
  ...
  // read in lists from cloud or local save depending on sign in state
