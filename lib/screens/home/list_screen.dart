...
import 'package:inventorymanagement/screens/bottom_sheets/add_item.dart';
import 'package:inventorymanagement/screens/bottom_sheets/edit_list.dart';
...
class _ListScreenState extends State<ListScreen> {
  ...
  void initState() {
    ...
    _items = [];
    // reload items when login state changes
    _authService.authStateChanges().listen((_) => _loadItems());
    _loadItems();
  }

  // save list items to cloud or local depending on sign in state
  ...
  // load list items from cloud or local depending on sign in state
